...
def invimb_latest():
    return jsonify({
        ...
        "exe_path": r"\\192.168.10.183\公共資料夾\Reports\INVIMB-update-2.1.8.exe",
        "changelog": "1. 更新優化"
    })
...
# Login audit queries, CSV exports and previewed retention cleanup.
register_audit_routes(app, lambda: db_conn(), USERNAME)
